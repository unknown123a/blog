...
ALLOWED_HOSTS = ["blog-production-5107.up.railway.app", "localhost", "127.0.0.1"]
CSRF_TRUSTED_ORIGINS = ['https://blog-production-5107.up.railway.app']
...
AUTHENTICATION_BACKENDS = [
    'app1.backend.EmailAuthBackend',  # Custom backend for email authentication
    'django.contrib.auth.backends.ModelBackend',  # Default username-based authentication
]

# Email settings (password will be hardcoded later)
EMAIL_BACKEND = 'django.core.mail.backends.smtp.EmailBackend'
EMAIL_HOST = 'smtp.gmail.com'
EMAIL_FROM = 'botcrafty5@gmail.com'
EMAIL_HOST_USER = 'botcrafty5@gmail.com'
EMAIL_HOST_PASSWORD = 'wmgzbsfncowwzjer'  # Hardcode it later
EMAIL_PORT = 587
EMAIL_USE_TLS = True
...
# Database settings (hardcoded password manually)
...
STATICFILES_DIRS = [BASE_DIR / 'app1/static']  # Your app’s static files
